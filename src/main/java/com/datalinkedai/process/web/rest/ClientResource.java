...
/**
 * REST controller for managing {@link com.datalinkedai.process.domain.Client}.
 */
@RestController
@RequestMapping("/api")
public class ClientResource {
    ...
    private static final String ENTITY_NAME = "processClient";
    ...
    public ResponseEntity<Client> updateClient(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, client.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Client> partialUpdateClient(
        ...
        return ResponseUtil.wrapOrNotFound(result, HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, client.getId()));
    }
